...
// *=============================== github calender ==================================
    GitHubCalendar(".calendar", "GryffindorAdi");

    // or enable responsive functionality:
    GitHubCalendar(".calendar", "GryffindorAdi", { responsive: true });
...
// *=============================== resume open in new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1rh-l4gOxCBDjrE4RTxA3_CcA8P1qcz-8/view?usp=sharing",
        "_blank"
      );
    }
